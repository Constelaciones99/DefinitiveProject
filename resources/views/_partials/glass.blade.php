<div class="container">
  ...
  <button class="btn border-2  border-white text-white dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">Search</button>
  <ul class="dropdown-menu" >
    <li><a class="dropdown-item" href="#">Autor</a></li>
    <li><a class="dropdown-item" href="#">Libro</a></li>
    <li><a class="dropdown-item" href="#">Persona</a></li>
    <li><hr class="dropdown-divider"></li>
    <li><a class="dropdown-item" href="#">Otros</a></li>
  </ul>
  <input type="text" class="form-control" id="place" placeholder="/Busca autor, persona, libro, ect" aria-label="Text input with dropdown button">
</div>
